          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="banner_id" id="input-banner" class="form-control">
                ...
                <?php if ($banner['banner_extend_id'] == $banner_id) { ?>
                <option value="<?php echo $banner['banner_extend_id']; ?>" selected="selected"><?php echo $banner['name']; ?></option>
                <?php } else { ?>
                <option value="<?php echo $banner['banner_extend_id']; ?>"><?php echo $banner['name']; ?></option>
                <?php } ?>
                <?php } ?>
              </select>
            </div>
