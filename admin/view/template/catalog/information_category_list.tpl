        ...
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-information">
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                <?php if ($information_categorys) { ?>
                <?php foreach ($information_categorys as $information_category) { ?>
                <tr>
                  <td class="text-center"><?php if (in_array($information_category['information_category_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php echo $information_category['name']; ?></td>
                  <td class="text-right"><?php echo $information_category['sort_order']; ?></td>
                  <td class="text-right"><a href="<?php echo $information_category['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
