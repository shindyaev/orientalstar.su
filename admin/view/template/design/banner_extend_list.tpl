          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($banner['banner_extend_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $banner['banner_extend_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $banner['banner_extend_id']; ?>" />
                    <?php } ?></td>
