 ...
 */
class ControllerToolUrlify extends Controller {
    ...
    public static $remove_list = array (
        ...
        'is', 'in', 'into', 'like', 'of', 'off', 'on', 'onto', 'per', 'quot',
     ...
     */
    public static function filter ($text, $length = 100, $language = "", $file_name = false, $use_remove_list = true) {
    ...
    public function autocomplete() {
        ...
        if (isset($this->request->get['url'])) {
            $json = ControllerToolUrlify::filter($this->request->get['url']);
        }
