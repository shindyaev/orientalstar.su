...
// Text
$_['text_success']                          = 'Успех: Вы успешно ипортировали ваши данные!';
$_['text_success_settings']                 = 'Успех: Вы успешно сохранили настройки модуля Экспорт / Импорт!';
...
$_['entry_incremental']                     = 'Использовать incremental Import';
$_['entry_upload']                          = 'File to be uploaded';
$_['entry_settings_use_option_id']          = 'Использовать <em>option_id</em> вместо <em>option name</em> в файлах \'ProductOptions\' и \'ProductOptionValues\'';
$_['entry_settings_use_option_value_id']    = 'Использовать <em>option_value_id</em> вместо <em>option_value name</em> в файле \'ProductOptionValues\'';
$_['entry_settings_use_attribute_group_id'] = 'Использовать <em>attribute_group_id</em> вместо <em>attribute_group name</em> в файле \'ProductAttributes\'';
$_['entry_settings_use_attribute_id']       = 'Использовать <em>attribute_id</em> вместо <em>attribute name</em> в файле \'ProductAttributes\'';
...
$_['entry_settings_use_export_cache']       = 'Использовать phpTemp cache for large Exports (will be slightly slower)';
$_['entry_settings_use_import_cache']       = 'Использовать phpTemp cache for large Imports (will be slightly slower)';
...
$_['error_categories_header']               = 'Export/Import: Invalid header in the Категории worksheet';
$_['error_category_filters_header']         = 'Export/Import: Invalid header in the CategoryFilters worksheet';
$_['error_products_header']                 = 'Export/Import: Invalid header in the Товары worksheet';
...
$_['error_product_options']                 = 'Export/Import: Missing Товары worksheet, or Товары worksheet not listed before ProductOptions';
$_['error_product_option_values']           = 'Export/Import: Missing Товары worksheet, or Товары worksheet not listed before ProductOptionValues';
...
$_['error_additional_images']               = 'Export/Import: Missing Товары worksheet, or Товары worksheet not listed before AdditionalImages';
$_['error_specials']                        = 'Export/Import: Missing Товары worksheet, or Товары worksheet not listed before Specials';
$_['error_discounts']                       = 'Export/Import: Missing Товары worksheet, or Товары worksheet not listed before Discounts';
$_['error_rewards']                         = 'Export/Import: Missing Товары worksheet, or Товары worksheet not listed before Rewards';
$_['error_product_attributes']              = 'Export/Import: Missing Товары worksheet, or Товары worksheet not listed before ProductAttributes';
...
$_['error_category_filters']                = 'Export/Import: Missing Категории worksheet, or Категории worksheet not listed before CategoryFilters';
$_['error_product_filters']                 = 'Export/Import: Missing Товары worksheet, or Товары worksheet not listed before ProductFilters';
...
$_['error_option_name']                    .= "Использовать <em>option_id</em> вместо <em>option name</em> в файлах 'ProductOptions' and 'ProductOptionValues'";
...
$_['error_missing_customer_group']                      = 'Export/Import: Missing customer_groups в файле \'%1\'!';
$_['error_invalid_customer_group']                      = 'Export/Import: Undefined customer_group \'%2\' used в файле \'%1\'!';
$_['error_missing_product_id']                          = 'Export/Import: Missing product_ids в файле \'%1\'!';
$_['error_missing_option_id']                           = 'Export/Import: Missing option_ids в файле \'%1\'!';
$_['error_invalid_option_id']                           = 'Export/Import: Undefined option_id \'%2\' used в файле \'%1\'!';
$_['error_missing_option_name']                         = 'Export/Import: Missing option_names в файле \'%1\'!';
$_['error_invalid_product_id_option_id']                = 'Export/Import: Option_id \'%3\' not specified for product_id \'%2\' в файле \'%4\', but it is used в файле \'%1\'!';
$_['error_missing_option_value_id']                     = 'Export/Import: Missing option_value_ids в файле \'%1\'!';
$_['error_invalid_option_id_option_value_id']           = 'Export/Import: Undefined option_value_id \'%3\' for option_id \'%2\' used в файле \'%1\'!';
$_['error_missing_option_value_name']                   = 'Export/Import: Missing option_value_names в файле \'%1\'!';
$_['error_invalid_option_id_option_value_name']         = 'Export/Import: Undefined option_value_name \'%3\' for optiion_id \'%2\' used в файле \'%1\'!'; 
$_['error_invalid_option_name']                         = 'Export/Import: Undefined option_name \'%2\' used в файле \'%1\'!';
$_['error_invalid_product_id_option_name']              = 'Export/Import: Option_name \'%3\' not specified for product_id \'%2\' в файле \'%4\', but it is used в файле \'%1\'!';
$_['error_invalid_option_name_option_value_id']         = 'Export/Import: Undefined option_value_id \'%3\' for option_name \'%2\' used в файле \'%1\'!';
$_['error_invalid_option_name_option_value_name']       = 'Export/Import: Undefined option_value_name \'%3\' for option_name \'%2\' used в файле \'%1\'!';
$_['error_missing_attribute_group_id']                  = 'Export/Import: Missing attribute_group_ids в файле \'%1\'!';
$_['error_invalid_attribute_group_id']                  = 'Export/Import: Undefined attribute_group_id \'%2\' used в файле \'%1\'!';
$_['error_missing_attribute_group_name']                = 'Export/Import: Missing attribute_group_names в файле \'%1\'!';
$_['error_missing_attribute_id']                        = 'Export/Import: Missing attribute_ids в файле \'%1\'!';
$_['error_invalid_attribute_group_id_attribute_id']     = 'Export/Import: Undefined attribute_id \'%3\' for attribute_group_id \'%2\' used в файле \'%1\'!';
$_['error_missing_attribute_name']                      = 'Export/Import: Missing attribute_names в файле \'%1\'!';
$_['error_invalid_attribute_group_id_attribute_name']   = 'Export/Import: Undefined attribute_name \'%3\' for optiion_id \'%2\' used в файле \'%1\'!'; 
$_['error_invalid_attribute_group_name']                = 'Export/Import: Undefined attribute_group_name \'%2\' used в файле \'%1\'!';
$_['error_invalid_attribute_group_name_attribute_id']   = 'Export/Import: Undefined attribute_id \'%3\' for attribute_group_name \'%2\' used в файле \'%1\'!';
$_['error_invalid_attribute_group_name_attribute_name'] = 'Export/Import: Undefined attribute_name \'%3\' for attribute_group_name \'%2\' used в файле \'%1\'!';
$_['error_missing_filter_group_id']                     = 'Export/Import: Missing filter_group_ids в файле \'%1\'!';
$_['error_invalid_filter_group_id']                     = 'Export/Import: Undefined filter_group_id \'%2\' used в файле \'%1\'!';
$_['error_missing_filter_group_name']                   = 'Export/Import: Missing filter_group_names в файле \'%1\'!';
$_['error_missing_filter_id']                           = 'Export/Import: Missing filter_ids в файле \'%1\'!';
$_['error_invalid_filter_group_id_filter_id']           = 'Export/Import: Undefined filter_id \'%3\' for filter_group_id \'%2\' used в файле \'%1\'!';
$_['error_missing_filter_name']                         = 'Export/Import: Missing filter_names в файле \'%1\'!';
$_['error_invalid_filter_group_id_filter_name']         = 'Export/Import: Undefined filter_name \'%3\' for optiion_id \'%2\' used в файле \'%1\'!'; 
$_['error_invalid_filter_group_name']                   = 'Export/Import: Undefined filter_group_name \'%2\' used в файле \'%1\'!';
$_['error_invalid_filter_group_name_filter_id']         = 'Export/Import: Undefined filter_id \'%3\' for filter_group_name \'%2\' used в файле \'%1\'!';
$_['error_invalid_filter_group_name_filter_name']       = 'Export/Import: Undefined filter_name \'%3\' for filter_group_name \'%2\' used в файле \'%1\'!';
$_['error_invalid_product_id']                          = 'Export/Import: Invalid product_id \'%2\' used в файле \'%1\'!';
$_['error_duplicate_product_id']                        = 'Export/Import: Duplicate product_id \'%2\' used в файле \'%1\'!';
$_['error_unlisted_product_id']                         = 'Export/Import: Worksheet \'%1\' cannot use product_id \'%2\' because it is not listed в файле \'Товары\'!';
